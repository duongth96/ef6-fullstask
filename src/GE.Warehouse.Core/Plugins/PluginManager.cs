...
using GE.Warehouse.Core.ComponentModel;
...
namespace GE.Warehouse.Core.Plugins
{
    /// <summary>
            ...
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains(WebVersion.CurrentVersion, StringComparer.InvariantCultureIgnoreCase))
                        {
