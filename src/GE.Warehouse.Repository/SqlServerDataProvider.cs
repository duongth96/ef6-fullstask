...
namespace GE.Warehouse.Repository
{
    public class SqlServerDataProvider : BaseEfDataProvider
    {
        ...
        public override void SetDatabaseInitializer()
        {
            ...
            var tablesToValidate = new[] { "Category", "Comment", "Image", "News", "Project", "ProjectFollow", "ProjectTag","Tag","User" };
            ...
            var initializer = new CreateTablesIfNotExist<DbObjectContext>(tablesToValidate, customCommands.ToArray());
