...
using Chatbox.Repository.EF.Configuration;
using MVCCore;

namespace Chatbox.Repository.EF
{
    /// <summary>
    /// Object context
    /// </summary>
    public class ObjectContext : DbContext, IDbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            System.Type configType = typeof(UserConfiguration);   //any of your configuration classes here
